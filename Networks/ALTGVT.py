from Networks import frozenPath
import torch
...
class GroupAttention(nn.Module):
    ...
    def forward(self, x, H, W):
        ...
        attn = self.attn_drop(
            attn)  # attn @ v-> B, hw, n_head, ws*ws, head_dim -> (t(templates,3)) B, hw, ws*ws, n_head,  head_dim
...
def alt_gvt_large(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        checkpoint = torch.load('Networks/alt_gvt_large.pth')
